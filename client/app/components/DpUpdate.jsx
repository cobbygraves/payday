...
export default function DpUpdate({ isModalOpen, toggleModal, id }) {
  ...
  const handleOk = async () => {
    ...
    formData.append('updateItem', 'dp')
    //send uploaded image to server and when there is a response toggle the modal
